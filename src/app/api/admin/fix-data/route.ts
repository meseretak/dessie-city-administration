...
export async function GET() {
  ...
  try {
    ...
    const allMenuItems = [
      ...
      { id: 'cat-biz',           label: 'Business & Property',   pageId: 'services', parentId: 'menu-services', order: 2 },
      { id: 'cat-public',        label: 'Public Services',       pageId: 'services', parentId: 'menu-services', order: 3 },
      { id: 'cat-other',         label: 'Other Services',        pageId: 'services', parentId: 'menu-services', order: 4 },
      // Civil Registration
      { id: 'svc-birth',         label: 'Birth Registration',    pageId: 'service-detail', parentId: 'cat-civil', order: 1 },
      { id: 'svc-marriage',      label: 'Marriage Registration', pageId: 'service-detail', parentId: 'cat-civil', order: 2 },
      { id: 'svc-id',            label: 'ID & Documents',        pageId: 'service-detail', parentId: 'cat-civil', order: 3 },
      // Business & Property
      { id: 'svc-biz',           label: 'Business License',      pageId: 'service-detail', parentId: 'cat-biz', order: 1 },
      { id: 'svc-permit',        label: 'Building Permit',       pageId: 'service-detail', parentId: 'cat-biz', order: 2 },
      { id: 'svc-land',          label: 'Land Services',         pageId: 'service-detail', parentId: 'cat-biz', order: 3 },
      { id: 'svc-tax',           label: 'Tax Payment',           pageId: 'service-detail', parentId: 'cat-biz', order: 4 },
      // Public Services
      { id: 'svc-health',        label: 'Health Services',       pageId: 'service-detail', parentId: 'cat-public', order: 1 },
      { id: 'svc-edu',           label: 'Education',             pageId: 'service-detail', parentId: 'cat-public', order: 2 },
      { id: 'svc-transport',     label: 'Transportation',        pageId: 'service-detail', parentId: 'cat-public', order: 3 },
      { id: 'svc-water',         label: 'Water & Electricity',   pageId: 'service-detail', parentId: 'cat-public', order: 4 },
      // Other Services
      { id: 'svc-complaint',     label: 'Complaints',            pageId: 'service-detail', parentId: 'cat-other', order: 1 },
      { id: 'svc-appointment',   label: 'Appointments',          pageId: 'service-detail', parentId: 'cat-other', order: 2 },
      { id: 'svc-tourism',       label: 'Tourism & Culture',     pageId: 'tourism',        parentId: 'cat-other', order: 3 },
      { id: 'svc-projects',      label: 'City Projects',         pageId: 'projects',       parentId: 'cat-other', order: 4 },
