"use client"
import PageComponent from "@/components/pages/ServiceDetailPage";
...
export default function Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <PageComponent serviceId={decodeURIComponent(unwrappedParams.id)} navigateTo={navigateTo} />;
}
